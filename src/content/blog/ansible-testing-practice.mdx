...
## Background
Because most of my experience now revolves around development and operations (thus DevOps), I wondered how would one test the Ansible script and works as expected? Here are some steps and techniques to help you test your Ansible scripts.
