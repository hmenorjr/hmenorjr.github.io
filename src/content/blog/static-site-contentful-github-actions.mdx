...
pubDate: 2020-12-20
image: ../../assets/blogs/github-plus-contentful.webp
...
![github bot account image](../../assets/blogs//github_bot_account.webp "github bot account image")

![github bot account in dashboard](../../assets/blogs//github_bot_account_dash.webp "github bot account in dashboard")

Make sure your "bot" have only one access which is the private repository.

![image of the permission of bot](../../assets/blogs//github_bot_permission.webp "image of the permission of bot")
...
### Developer Settings
![image of developer settings](../../assets/blogs//developer_settings.webp "image of developer settings")

### Personal access tokens
![image of personal access token config](../../assets/blogs//personal_access_tokens.webp "image of personal access token config")

### Click on `repo`
![image of developer settings repository](../../assets/blogs//developer_settings_repo.webp "image of developer settings repository")
